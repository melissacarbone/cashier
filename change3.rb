...
while true
  ...
  if selection == "1"
    ...
    puts "Input invalid.  Your subtotal is #{subtotal_l.to_f + subtotal_m.to_f + subtotal_b.to_f}"
  end
...
#     prices << price.to_f
#     subtotal += price.to_f.round(2)
#     puts "Your subtotal is: $#{subtotal}"
# end
# puts "Your total amount due is $#{subtotal}"
...
#       change = (tender.to_f - subtotal.to_f).round(2)
#       if change > 0
